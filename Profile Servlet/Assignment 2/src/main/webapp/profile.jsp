            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <form action="ViewInquiry" method="post">
                        <input type="submit" value="Inquiry's List"> </form></a></li>
                        <li class="nav-item"><a class="nav-link">
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">CSC584 Enterprise Programming, Individual Assignment</p>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <hr class="divider" />
                        <p class="text-muted mb-5">Any questions and want to have a talk? Send me a messages and I will get back to you as soon as possible!</p>
                    </div>
                </div>
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <form action="addInquiry" method="post">
                            ...
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="message" name="inquiry" type="text" placeholder="Enter your message here..." style="height: 10rem" required="true"> </textarea>
                            ...
                            <!-- Submit Button-->
                            <div class="d-grid">
                            <input type="submit" value="Submit Inquiry" class="btn btn-primary btn-xl">
                            <!-- <button type="submit" value="Submit Inquiry" class="btn btn-primary btn-xl disabled" id="submitButton">Submit</button>--></div>
                        </form>
                    </div>
                </div>
                <div class="row gx-4 gx-lg-5 justify-content-center">
